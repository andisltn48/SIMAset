<x-app-layout title="Edit Data Inventaris">
    <div class="mt-4 card shadow p-3 mb-5 bg-white rounded dataaset-card" style="border-radius: 0.7rem !important">
        <div class="row container-dataaset header-dataaset">
            <div class="col-12 col-md-8 title">
                <h5 class="fw-bold">Edit Data Inventaris</h5>
            </div>
        ...
        <hr>
        <div>
            <form action="{{ route('data-inventaris.update', $datainventaris->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @if (session('error'))
                ...
                <div class="d-flex row-edit mt-3">
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ $datainventaris->nama_barang }}" name="nama_barang" type="text"
                    ...
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ $datainventaris->kode }}" name="kode_barang" type="text" class="form-control"
                                required>
                        </div>
                    ...
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ $datainventaris->uraian_barang }}" name="uraian_barang" type="text"
                                class="form-control" required>
                        </div>
                    </div>
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ $datainventaris->nup }}" name="nup" type="text" class="form-control"
                                required>
                        </div>
                    </div>
                </div>
                <div class="d-flex row-edit mt-3">
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ $datainventaris->harga_satuan }}" name="harga_satuan" type="text"
                    ...
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ $datainventaris->harga_total }}" name="harga_total" type="text"
                                class="form-control" id="rupiah" required>
                        </div>
                    </div>
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ $datainventaris->nilai_tagihan }}" name="nilai_tagihan" type="text"
                                class="form-control" id="rupiah" required>
                        </div>
                    </div>
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ date('Y-m-d\TH:i:s', strtotime($datainventaris->tanggal_SP2D)) }}"
                ...
                <div class="d-flex row-edit mt-3">
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ $datainventaris->nomor_SP2D }}" name="nomor_sp2d" type="text"
                                class="form-control" required>
                        </div>
                        <div class="text-danger">
                            @error('nomor_sp2d')
                    ...
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input value="{{ $datainventaris->kelompok_belanja }}" name="kelompok_belanja" type="text"
                                class="form-control" required>
                        </div>
                    </div>
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="asal_perolehan"
                                value="{{ $datainventaris->asal_perolehan }}" required>
                        </div>
                    </div>
                    <div class="col m-1" >
                        <div class="">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="nomor_bukti_perolehan"
                                value="{{ $datainventaris->nomor_bukti_perolehan }}" required>
                        </div>
                        <div class="text-danger">
                ...
                <div class="d-flex row-edit mt-3">
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="merk" value="{{ $datainventaris->merk }}"
                                required>
                        </div>
                    </div>
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="sumber_dana"
                                value="{{ $datainventaris->sumber_dana }}" required>
                        </div>
                    </div>
                    <div class="col m-1" >
                        <div class="">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="pic" value="{{ $datainventaris->pic }}"
                                required>
                        </div>
                    </div>
                    <div class="col m-1" >
                      ...
                      <div class="form-group">
                          <select  class="form-select select2 " id="filter-koderuangan" name="kode_ruangan" onchange="ruanganselect()">
                              ...
                              @foreach($dataruangan as $data)
                                @if ($datainventaris->kode_ruangan == $data->kode_ruangan)
                                  <option selected value="{{$data->kode_ruangan}}">{{$data->kode_ruangan}} || {{$data->nama_ruangan}}</option>
                                @else
                ...
                <div class="d-flex row-edit mt-3">
                    <div class="col m-1">
                        ...
                        <div class="form-group">
                            <input id="ruangan" name="ruangan" value="{{ $datainventaris->ruangan }}" type="text"
                                class="form-control">
                        </div>
                    </div>
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <select name="unit" class="form-select select2" required>
                                ...
                                @foreach ($unit as $item)
                                    @if ($item->kode_unit == $datainventaris->unit)
                    ...
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input name="gedung" value="{{ $datainventaris->gedung }}" type="text" class="form-control">
                        </div>
                    </div>
                ...
                <div class="d-flex row-edit mt-3">
                    <div class="col m-1" >
                        ...
                        <div class="form-group">
                            <input required name="tahun_pengadaan" value="{{ $datainventaris->tahun_pengadaan }}" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="col m-1">
                        <div class="">
                    ...
                    <div class="col m-1">
                        ...
                        <div class="form-group">
                            <textarea name="catatan" class="form-control" id="exampleFormControlTextarea1"
                                rows="3">{{ $datainventaris->catatan }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col text-center">
                        ...
                        <a href="{{ route('data-inventaris.index') }}" class=" btn btn-block btn-danger"><i
          ...
          let value = $('#filter-koderuangan').val();
            if ( value.length > 0) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('data-inventaris.get-ruangan') }}",
                    type: "get",
                    data: {
                        kode: value
                    },
