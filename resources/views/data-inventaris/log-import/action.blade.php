<div class="d-flex justify-content-around ">
    <div>
        <a href="{{ route('data-inventaris.detail-riwayat-import', $model->id) }}"
    ...
    <div>
        <form action="{{ route('data-inventaris.destroy-log-import', $model->id) }}" method="POST">
            @csrf
    ...
    <script>
        function confirm_delete() {
            return confirm('Apakah anda yakin untuk menghapus riwayat impor data inventaris ini ? ');
        }
    </script>
</div>
