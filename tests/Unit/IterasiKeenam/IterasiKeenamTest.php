...
class IterasiKeenamTest extends TestCase
{
    ...
    //     $response = $this->actingAs($user)->post(route('peminjaman.confirm-request', 4), $request);
    ...
    //     $response = $this->actingAs($user)->post(route('peminjaman.confirm-request', 6), $request);
